...
/**
 * TrainersSearch represents the model behind the search form about `app\modules\trainers\models\Trainers`.
 */
class TrainersSearch extends Trainers
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['name', 'website', 'logo', 'motto', 'mission', 'vision', 'brief', 'active'], 'safe'],
        ];
    }
